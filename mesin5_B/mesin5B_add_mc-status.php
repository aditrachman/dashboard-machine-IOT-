...
//  Untuk menambah status mach_stop pada kolom 'remark' di data terakhir 
	...
	$sql_1 = "SELECT * FROM mesin5_b ORDER BY id DESC LIMIT 1";  //ORDER BY id DESC LIMIT 1  
	...
	// tambah 'mach_stop'
	$sql_2 = "UPDATE mesin5_b SET remark='mach_stop' WHERE id = $id_terakhir ";
...
// Masukkan data dari mesin ke dbase 
	...
	include('mesin5B_koneksi.php');
    $sensor = $_GET['nilaiD1danD2'];
    $sql = "INSERT INTO mesin5_b (qty) VALUES (:nilaiD1danD2)";
