...
//  Untuk menambah status mach_stop pada kolom 'remark' di data terakhir 
	...
	$sql_1 = "SELECT * FROM mesin3_b ORDER BY id DESC LIMIT 1";  //ORDER BY id DESC LIMIT 1  
	...
	// tambah 'mach_stop'
	$sql_2 = "UPDATE mesin3_b SET remark='mach_stop' WHERE id = $id_terakhir ";
...
// Masukkan data dari mesin ke dbase 
	...
	include('mesin3B_koneksi.php');
    $sensor = $_GET['nilaiD1danD2'];
    $sql = "INSERT INTO mesin3_b (qty) VALUES (:nilaiD1danD2)";
