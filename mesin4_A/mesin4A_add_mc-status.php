...
//  Untuk menambah status mach_stop pada kolom 'remark' di data terakhir 
	...
	$sql_1 = "SELECT * FROM mesin4_a ORDER BY id DESC LIMIT 1";  //ORDER BY id DESC LIMIT 1  
	...
	// tambah 'mach_stop'
	$sql_2 = "UPDATE mesin4_a SET remark='mach_stop' WHERE id = $id_terakhir ";
...
// Masukkan data dari mesin ke dbase 
	...
	include('mesin4A_koneksi.php');
    $sensor = $_GET['nilaiD1danD2'];
    $sql = "INSERT INTO mesin4_a (qty) VALUES (:nilaiD1danD2)";
